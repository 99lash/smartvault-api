        ...
        try:
            ...
            try:
                ...
                with SessionLocal() as db:
                    ...
                    logs = service.get_filtered_logs_by_vault(str(query_params.vault_id), query_params.prefixes) # type: ignore
                ...
                while True:
                    ...
                    if msg == "refresh":
                        ...
                        with SessionLocal() as db_refresh:
                            ...
                            updated_logs = service_refresh.get_filtered_logs_by_vault(str(query_params.vault_id), query_params.prefixes) # type: ignore
                            update_resp = {
                                "status": "ok",
                                "type": "refresh",
                                "logs": updated_logs
